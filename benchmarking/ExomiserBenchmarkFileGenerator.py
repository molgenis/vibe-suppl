...
"""
Name:
    ExomiserBenchmarkFileGenerator.py
Example:
    ExomiserBenchmarkFileGenerator.py input/ output.tsv

Description:
    Processes the output from ExomiserBenchmarkRunner.py for usage in R plots.
"""
