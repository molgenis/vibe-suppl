...
"""
Name:
    BenchmarkFileHpoConverter.py
Example:
    GeneNetworkBenchmarkRunner.py hp.obo benchmark_data.tsv output.tsv

Description:
    Converts the HPO names from benchmark_data.tsv in the fifth column into their HPO codes (HP:xxxxxxx).
"""
